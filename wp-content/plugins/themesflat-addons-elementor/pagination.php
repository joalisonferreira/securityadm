		...
		if($style == 'numeric'){
			...
			if ( \Elementor\Plugin::$instance->editor->is_edit_mode() ) {
                ...
                <nav class="navigation loadmore" role="navigation">
                    <div class="pagination loop-pagination <?php echo esc_attr($align); ?>">            
                    <a href=" <?php echo esc_url( get_next_posts_page_link() ); ?> "><?php echo esc_html__('Load More', 'themesflat-addons'); ?></a>
                    </div>
                </nav>
                <?php
            }else {
                ...
                <nav class="navigation loadmore" role="navigation">
                    <div class="pagination loop-pagination <?php echo esc_attr($align); ?>">
                    <?php echo next_posts_link( esc_html__( 'Load More', 'themesflat-addons' ), $query->max_num_pages ); ?>
                    </div>
                </nav>
                <?php
            }
