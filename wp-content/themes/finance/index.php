...
<div class="col-md-12">	
	...
	<div id="primary" class="content-area <?php echo themesflat_choose_opt('blog_style') ?>">
		<main id="main" class="post-wrap <?php echo themesflat_choose_opt('blog_grid_columns') ?>" role="main">
