...
class TFTabs_Widget_Free extends \Elementor\Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'TF Tabs', 'themesflat-addons' );
    }
	...
	protected function register_controls() {
        // Start Tab Setting        
	        ...
	        $repeater->add_control( 'list_title', [
					...
					'default' => esc_html__( 'Tab' , 'themesflat-addons' ),
					'label_block' => true,
				]
			);
			...
			$repeater->add_control( 'list_content_template',
				[
					...
					'type' => \Elementor\Controls_Manager::SELECT,
					'options' => ThemesFlat_Addon_For_Elementor_Finance::tf_get_template_elementor(),
					'condition' => [
	        ...
	        $this->add_control( 'tab_list',
				[					
					...
					'default' => [
						[
							'list_title' => esc_html__( 'Tab 1', 'themesflat-addons' ),
						...
						[
							'list_title' => esc_html__( 'Tab 2', 'themesflat-addons' ),
							'list_content' => esc_html__( 'Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi utaliquip commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit ess cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt.', 'themesflat-addons' ),
						],
						[
							'list_title' => esc_html__( 'Tab 3', 'themesflat-addons' ),
							'list_content' => esc_html__( 'Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi utaliquip commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit ess cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt.', 'themesflat-addons' ),
						],
					],
			...
			$this->add_control( 'tab_type',
				[
					...
					'options' => [
						...
						'vertical' => esc_html__( 'Vertical', 'themesflat-addons' ),
					],
				]
			);	
	    ...
	    // Start Style Icon
	        $this->start_controls_section( 'section_style_icon',
	            [
	                'label' => esc_html__( 'Tab Icon', 'themesflat-addons' ),
			...
			$this->add_responsive_control( 'icon_gap',
				[
					'label' => esc_html__( 'Gap', 'themesflat-addons' ),
					'type' => \Elementor\Controls_Manager::SLIDER,
					'size_units' => [ 'px' ],
					'range' => [
						'px' => [
	    ...
	    // Start Style Title
	        ...
	        $this->add_control( 'heading_wrap_nav',
				[
					'label' => esc_html__( 'Wrap Nav', 'themesflat-addons' ),
					'type' => \Elementor\Controls_Manager::HEADING,
				]
			);
	        ...
	        $this->add_control( 'heading_nav',
				[
					'label' => esc_html__( 'Item Nav', 'themesflat-addons' ),
					'type' => \Elementor\Controls_Manager::HEADING,
					'separator' => 'before',
				]
			);				
	        	...
	        	$this->start_controls_tab( 'title_style_normal_tab',
					...
					$this->add_group_control( \Elementor\Group_Control_Background::get_type(),
						[
							...
							'label' => esc_html__( 'Background Type', 'themesflat-addons' ),
	    ...
	    // Start Tab Style Content 
	        $this->start_controls_section( 'section_style_content',
	            [
	                'label' => esc_html__( 'Tab Content', 'themesflat-addons' ),
	                'tab' => \Elementor\Controls_Manager::TAB_STYLE,
	            ]
	        );
			...
			$this->add_control( 'content_entrance_animation',
				[
					'label' => esc_html__( 'Entrance Animation', 'themesflat-addons' ),
					'type' => \Elementor\Controls_Manager::SELECT,
					'label_block' => true,
					'default' => 'fadeIn',
					'options' => [
						...
						'fadeInDown' => esc_html__( 'Fade In Down', 'themesflat-addons' ),
						'fadeInLeft' => esc_html__( 'Fade In Left', 'themesflat-addons' ),
						'fadeInRight' => esc_html__( 'Fade In Right', 'themesflat-addons' ),
						'fadeInUp' => esc_html__( 'Fade In Up', 'themesflat-addons' ),
						'zoomIn'  => esc_html__( 'Zoom In', 'themesflat-addons' ),						
						'zoomInDown' => esc_html__( 'Zoom In Down', 'themesflat-addons' ),
						'zoomInLeft' => esc_html__( 'Zoom In Left', 'themesflat-addons' ),
						'zoomInRight' => esc_html__( 'Zoom In Right', 'themesflat-addons' ),
						'zoomInUp' => esc_html__( 'Zoom In Up', 'themesflat-addons' ),
						'bounceIn'  => esc_html__( 'Bounce In', 'themesflat-addons' ),						
						'bounceInDown' => esc_html__( 'Bounce In Down', 'themesflat-addons' ),
						'bounceInLeft' => esc_html__( 'Bounce In Left', 'themesflat-addons' ),
						'bounceInRight' => esc_html__( 'Bounce In Right', 'themesflat-addons' ),
						'bounceInUp' => esc_html__( 'Bounce In Up', 'themesflat-addons' ),
						'slideInDown' => esc_html__( 'Slide In Down', 'themesflat-addons' ),
						'slideInLeft' => esc_html__( 'Slide In Left', 'themesflat-addons' ),
						'slideInRight' => esc_html__( 'Slide In Right', 'themesflat-addons' ),
						'slideInUp' => esc_html__( 'Slide In Up', 'themesflat-addons' ),
						'rotateIn'  		=> esc_html__( 'Rotate In', 'themesflat-addons' ),						
						'rotateInDownLeft' 	=> esc_html__( 'Rotate In Down Left', 'themesflat-addons' ),
						'rotateInDownRight' => esc_html__( 'Rotate In Down Right', 'themesflat-addons' ),
						'rotateInUpLeft' 	=> esc_html__( 'Rotate In Up Left', 'themesflat-addons' ),
						'rotateInUpRight' => esc_html__( 'Rotate In Up Right', 'themesflat-addons' ),
						'bounce'  => esc_html__( 'Bounce', 'themesflat-addons' ),						
						'flash' => esc_html__( 'Flash', 'themesflat-addons' ),
						'pulse' => esc_html__( 'Pulse', 'themesflat-addons' ),
						'rubberBand' => esc_html__( 'Rubber Band', 'themesflat-addons' ),
						'shake' => esc_html__( 'Shake', 'themesflat-addons' ),
						'headShake'  => esc_html__( 'Head Shake', 'themesflat-addons' ),						
						'swing' => esc_html__( 'Swing', 'themesflat-addons' ),
						'tada' => esc_html__( 'Tada', 'themesflat-addons' ),
						'wobble' => esc_html__( 'Wobble', 'themesflat-addons' ),
						'jello' => esc_html__( 'Jello', 'themesflat-addons' ),
						'lightSpeedIn' => esc_html__( 'Light Speed In', 'themesflat-addons' ),
						'rollIn' => esc_html__( 'Roll In', 'themesflat-addons' ),
					],
				]
			);
        ...
        // Start Tab Style Triger
	        $this->start_controls_section( 'section_style_triger',
	            [
	                'label' => esc_html__( 'Tab Active Triger', 'themesflat-addons' ),
	                'tab' => \Elementor\Controls_Manager::TAB_STYLE,
	            ]
	        );
	        ...
	        $this->add_control(
				'show_triger',
				[
					'label' => esc_html__( 'Show Triger', 'themesflat-addons' ),
					'type' => \Elementor\Controls_Manager::SWITCHER,
					'label_on' => esc_html__( 'Show', 'themesflat-addons' ),
					'label_off' => esc_html__( 'Hide', 'themesflat-addons' ),
					'return_value' => 'yes',
			...
			$this->add_responsive_control( 'triger_size',
				[
					'label' => esc_html__( 'Triger Size', 'themesflat-addons' ),
					'type' => \Elementor\Controls_Manager::SLIDER,
					'size_units' => [ 'px' ],
					'range' => [
						'px' => [
