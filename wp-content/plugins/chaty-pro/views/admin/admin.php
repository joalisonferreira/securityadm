            ...
            <section class="grid grid-cols-1 lg:grid-cols-3 overflow-x-hidden sm:overflow-visible rounded-lg border border-gray-150/40 bg-white" id="chaty-widget-body-tab">
                ...
                <aside class="preview-section-chaty pb-20 z-0">
                    <div class="preview sticky top-28 ease-linear duration-300" id="admin-preview">
                        <h2 class="text-white"><span class="header-tooltip text-white"><span class="header-tooltip-text">Please make all your live tests in <a href="https://www.computerworld.com/article/3356840/how-to-go-incognito-in-chrome-firefox-safari-and-edge.html" target="_blank">incognito mode</a>. Some of the features like call to action, attention effect, and trigger will appear for your website visitors just once until they engage with the chat widget, so to emulate it you'll need to use incognito mode</span> <span class="dashicons dashicons-editor-help text-white"></span></span><?php esc_html_e('Preview', 'chaty'); ?>:</h2>
                ...
                <div class="chaty-sticky-buttons">
                    ...
                    <?php if (!empty($this->widget_index) && $this->widget_index != '_new_widget' && false) { ?>
                        <a href="javascript:;" data-nonce="<?php echo wp_create_nonce("chaty_remove_".$this->widget_index) ?>" class="remove-chaty-widget-sticky remove-chaty-options">Remove</a>
                    <?php } ?>
                </div>
            </section>
        </form>
