    ...
    <div class="form-horizontal space-y-7">
        <div class="form-horizontal__item" id="trigger-setting">
            ...
            <div class="flex items-center space-x-2">
                <div>
                    ...
                    <label class="text-base text-cht-gray-150 font-primary" for="active_widget">Active</label>
                </div>
            ...
            <div class="trigger-block group-control-wrap trigger-block-wrapper">
                ...
                <div class="trigger-tooltip border-t border-x-0 border-b-0 border-solid border-[#eaeff2] py-3.5 px-5">
                    <span data-target="uid-123456" class="chaty-targeted-collapse flex-inline items-center font-primary text-base space-x-1 text-cht-primary cursor-pointer">
                        ...
                        <span>How triggers works?</span>
                    </span>
                    <p id="uid-123456" class="text-sm text-cht-gray-150 font-primary px-2 pt-2 hidden">Your Chaty widget will first appear to the user according to the selected trigger. After the widget appeared for the first time, it'll always be visible on-load - once the user is aware of the widget, the user expects it to always appear</p>
        ...
        <div class="form-horizontal__item" id="custom-rules">
            ...
            <div class="chaty-option-box <?php echo esc_attr($page_options_class) ?>">
                            ...
                            <div class="chaty-page-option group-control-wrap mb-2 py-5 pl-5 pr-7 <?php echo !$is_pro ? 'not-pro': '' ?> relative <?php echo esc_attr($k == count($page_option) ? "last" : ""); ?>">
                                <div class="url-content <?php echo !$is_pro ? 'pointer-events-none': '' ?> <?php echo esc_attr(@($option['option'] == "home") ? "v-hide" : "") ?>">
                                    ...
                                    <div class="sm:flex items-center mt-2 <?php echo esc_attr(!empty($option['option']) && $option['option'] != "home" ? "active" : "") ?>">
                                        <div class="url-box">
                                            <span class='chaty-url url-title <?php echo esc_attr(!in_array($option['option'], ["wp_pages", "wp_posts", "wp_categories", "wp_tags", "wc_products_on_sale", "wc_products"])?"active":"") ?>'><?php echo esc_attr(site_url("/")); ?></span>
                                            <span class='chaty-wp_pages url-title <?php echo esc_attr($option['option'] == "wp_pages")?"active":"" ?>'><?php esc_html_e("Pages"); ?></span>
                                            <span class='chaty-wp_posts url-title <?php echo esc_attr($option['option'] == "wp_posts")?"active":"" ?>'><?php esc_html_e("Posts"); ?></span>
                                            <span class='chaty-wp_categories url-title <?php echo esc_attr($option['option'] == "wp_categories")?"active":"" ?>'><?php esc_html_e("Categories"); ?></span>
                                            <span class='chaty-wp_tags url-title <?php echo esc_attr($option['option'] == "wp_tags")?"active":"" ?>'><?php esc_html_e("Tags"); ?></span>
                                            <span class='chaty-wc_products url-title <?php echo esc_attr($option['option'] == "wc_products")?"active":"" ?>'><?php esc_html_e("Products"); ?></span>
                                            <span class='chaty-wc_products_on_sale url-title <?php echo esc_attr($option['option'] == "wc_products_on_sale")?"active":"" ?>'><?php esc_html_e("Products"); ?></span>
                                        </div>
                ...
                <div class="<?php echo esc_attr($is_pro ? 'is-pro': 'not-pro') ?>">
                    <a href="javascript:;" class="create-rule mr-3 border border-solid border-cht-gray-150/60 text-cht-gray-150 text-base px-3 py-1 rounded-lg inline-block hover:text-cht-primary hover:border-cht-primary" id="create-rule">Add Rule</a>
                    <a href="javascript:;" id="remove-page-rules" class="px-3 py-1 hidden remove-rules rounded-lg bg-transparent  text-red-500 hover:bg-red-500/10  focus:bg-red-500/10 hover:text-red-500 focus:text-red-500 border border-solid border-red-500 text-base">Remove Rules</a>
                </div>
            </div>
        </div>
        ...
        <div class="form-horizontal__item">
            ...
            <div class="chaty-option-box <?php echo esc_attr($time_card_class) ?>">
                ...
                <div class="rule-btns <?php echo esc_attr($is_pro ? 'pro': 'not-pro') ?>">
                    <a href="javascript:;" class="create-rule border mr-3 border-solid border-cht-gray-150/60 text-cht-gray-150 text-base px-3 py-1 rounded-lg inline-block hover:text-cht-primary hover:border-cht-primary" id="create-data-and-time-rule">Add Rule</a>
                    <a href="javascript:;" class="px-3 py-1 hidden remove-day-time-rules remove-rules rounded-lg bg-transparent  text-red-500 hover:bg-red-500/10  focus:bg-red-500/10 hover:text-red-500 focus:text-red-500 border border-solid border-red-500 text-base">Remove Rules</a>
                </div>
            </div>
        </div>
                    ...
                    <div class="trigger-block mt-4 space-y-3">
                        <div class="traffic-rules <?php echo esc_attr($is_pro ? "is-pro" : "not-pro") ?>">
                            ...
                            <div class="traffic-custom-rules">
                                <div class="custom-rule-title font-primary text-cht-gray-150 text-base block my-2">Specific URL</div>
                        ...
                        <div class="traffic-rule-actions">
                            <?php if($is_pro) { ?>
                                <a href="javascript:;" class="create-rule border border-solid border-cht-gray-150/60 text-cht-gray-150 text-base px-3 py-1 rounded-lg inline-block hover:text-cht-primary hover:border-cht-primary" id="add-traffic-rule">Add Rule</a>
                            <?php } ?>
                            <a href="javascript:;" class="create-rule remove-rules rounded-lg bg-transparent border-red-500/50 text-base text-red-500 hover:bg-red-500/10  focus:bg-red-500/10 hover:text-red-500 btn btn-primary inline-block ml-2 px-3 py-1" id="remove-traffic-rules">Remove Rules</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="form-horizontal__item">
            ...
            <div class="country-option-box <?php echo esc_attr($count?"show-remove-rules-btn":"") ?>">
                ...
                <div class="z-10">
                    <a href="javascript:;" class="create-rule mr-3 border border-solid border-cht-gray-150/60 text-cht-gray-150 text-base px-3 py-1 rounded-lg inline-block hover:text-cht-primary hover:border-cht-primary" id="create-country-rule">Add Rule</a>
                    <a href="javascript:;" class="px-3 py-1 hidden remove-rules rounded-lg bg-transparent  text-red-500 hover:bg-red-500/10  focus:bg-red-500/10 hover:text-red-500 focus:text-red-500 border border-solid border-red-500 text-base" id="remove-country-rules">Remove Rules</a>
                </div>
            </div>
        </div>
    ...
    <div class="chaty-page-option group-control-wrap mb-2 py-5 pl-5 pr-7 relative  <?php echo esc_attr($is_pro ? "is-pro" : "not-pro") ?>">
        <div class="url-content">
            ...
            <div class="sm:flex items-center mt-2">
                <div class="url-box">
                    <span class='chaty-url url-title active'><?php echo esc_attr(site_url("/")); ?></span>
