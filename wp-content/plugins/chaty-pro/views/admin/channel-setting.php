...
//                        $value['value'] = "+".$value['value'];
                ...
                echo '<div class="form-field-setting-col">';
                    ...
                    <div class="field-setting-col">
                        ...
                        <div class="block">
                            <label class="chaty-switch mb-4 chaty-switch-toggle text-cht-gray-150 text-base" for="field_for_<?php echo esc_attr($social['slug']); ?>_<?php echo esc_attr($label) ?>">
        ...
        <?php if ($social['slug'] == "Whatsapp" || $social['slug'] == "Link" || $social['slug'] == "Custom_Link" || $social['slug'] == "Custom_Link_3" || $social['slug'] == "Custom_Link_4" || $social['slug'] == "Custom_Link_5") { ?>
            <div class="Whatsapp-settings advanced-settings extra-chaty-settings">
                ...
                <div class="whatsapp-welcome-message mt-4 <?php echo ($embedded_window == "yes") ? "active" : "" ?>">
                    <div class="chaty-setting-col">
                        <label class="text-base text-cht-gray-150" style="display: block; width: 100%" for="cht_social_embedded_message_<?php echo esc_attr($social['slug']); ?>">Welcome message</label>
                        <div class="w-full">
                            <div class="w-full">
                    ...
                    <div class="chaty-setting-col mt-4">
                        ...
                        <label class="chaty-switch text-base font-primary text-cht-gray-150" for="whatsapp_default_open_embedded_window_<?php echo esc_attr($social['slug']); ?>">
                            ...
                            <span class="icon label-tooltip" data-title="Open the WhatsApp chat popup on page load, after the user sends a message or closes the window, the window will stay closed to avoid disruption"><span><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                                    <path d="M8.00004 14.6654C11.6819 14.6654 14.6667 11.6806 14.6667 7.9987C14.6667 4.3168 11.6819 1.33203 8.00004 1.33203C4.31814 1.33203 1.33337 4.3168 1.33337 7.9987C1.33337 11.6806 4.31814 14.6654 8.00004 14.6654Z" stroke="#72777c" stroke-width="1.33" stroke-linecap="round" stroke-linejoin="round"/>
                                    <path d="M8 10.6667V8" stroke="#72777c" stroke-width="1.33" stroke-linecap="round" stroke-linejoin="round"/>
                                    <path d="M8 5.33203H8.00667" stroke="#72777c" stroke-width="1.33" stroke-linecap="round" stroke-linejoin="round"/>
                                </svg></span></span>
        ...
        <div class="chaty-advance-settings <?php echo esc_attr($class_name); ?>" style="<?php echo (empty($close_class) && $social['slug'] == 'Contact_Us') ? "display:block" : ""; ?>">
            <div class="chaty-channel-setting space-y-4">
                ...
                <div class="chaty-setting-col sm:flex items-center space-y-2 sm:space-y-0 sm:space-x-3">
                    <label class="font-primary text-base text-cht-gray-150 sm:w-44">Icon Appearance</label>
                    <div class="flex items-center">
                        ...
                        <div class="flex items-center space-x-2">
                            ...
                            <?php if ($this->is_pro()) { ?>
                                ...
                                <a onclick="upload_chaty_image('<?php echo esc_attr($social['slug']); ?>')" href="javascript:;" class="upload-chaty-icon flex items-center px-2"><span class="dashicons dashicons-upload"></span> <span class="hidden sm:inline-block ml-1">Custom Image</span></a>
                            ...
                            <?php } else { ?>
                                <div class="pro-features ml-2">
                                    <div class="pro-item">
                                        <a target="_blank" href="<?php echo esc_url($this->getUpgradeMenuItemUrl());?>" class="upload-chaty-icon flex items-center px-2"><span class="dashicons dashicons-upload"></span> <span class="hidden sm:inline-block ml-1">Custom Image</span></a>
                                    </div>
                                    <div class="pro-button">
                                ...
                                <div class="pro-features">
                                    <div class="pro-item">
                                        <a target="_blank" href="<?php echo esc_url($this->getUpgradeMenuItemUrl());?>" class="upload-chaty-icon upload-icon inline-block px-2">Change Icon</a>
                                    </div>
                                    <div class="pro-button">
                ...
                <?php if ($social['slug'] == "Link" || $social['slug'] == "Custom_Link" || $social['slug'] == "Custom_Link_3" || $social['slug'] == "Custom_Link_4" || $social['slug'] == "Custom_Link_5") {
                    ...
                    <div class="chaty-setting-col sm:flex items-center sm:space-x-3">
                        <label class="font-primary text-base text-cht-gray-150 sm:w-44">Channel type</label>
                        <div>
                ...
                <div class="chaty-setting-col sm:flex sm:items-center sm:space-x-3">
                    <label class="font-primary text-base text-cht-gray-150 sm:w-44">On Hover Text
                    <span class="header-tooltip">
                ...
                <div class="Whatsapp-settings advanced-settings">
                    <div class="chaty-setting-col sm:flex items-start space-y-2 sm:space-y-0 sm:space-x-3">
                        ...
                        <div class="group-custom relative">
                            <div class="pre-message-whatsapp">
                                ...
                                <input 
                                    ...
                                    class="pre-set-message-whatsapp <?php echo esc_attr(!$this->is_pro() ? 'pointer-events-none': '') ?>" 
                            ...
                            <span class="supported-tags mt-2 text-cht-gray-150"><span class="icon label-tooltip support-tooltip" data-title="{title} tag grabs the page title of the webpage">{title}</span> and  <span class="icon label-tooltip support-tooltip" data-title="{url} tag grabs the URL of the page">{url}</span> tags are supported</span>
                            <?php if (!$this->is_pro()) : ?>
                ...
                <div class="Whatsapp-settings advanced-settings">
                    <div class="chaty-setting-col sm:flex items-center space-y-2 sm:space-y-0 sm:space-x-3">
                        <label class="font-primary text-base text-cht-gray-150 sm:w-44">Whatsapp Web
                        <span class="header-tooltip">
                ...
                <?php if ($social['slug'] == "Contact_Us") { ?>
                    <div class="Contact_Us-settings advanced-settings">
                        <div class="clear clearfix"></div>
                        <div class="chaty-setting-col sm:flex sm:items-center sm:space-x-3">
                            <label class="font-primary text-cht-gray-150 text-base w-44">Contact Form Title</label>
                            <div>
                                <?php $contact_form_title = isset($value['contact_form_title']) ? $value['contact_form_title'] : esc_html__("Contact Us", "chaty"); ?>
                                <input id="cht_social_message_<?php echo esc_attr($social['slug']); ?>_form_title" type="text" name="cht_social_<?php echo esc_attr($social['slug']); ?>[contact_form_title]" value="<?php echo esc_attr($contact_form_title) ?>" >
                            </div>
                        </div>
                        ...
                        <div class="form-field-setting-col my-3 space-y-4">
                            ...
                            <div class="color-box space-y-4">
                                <div class="clr-setting">
                                    ...
                                    <div class="chaty-setting-col flex items-center space-x-3">
                                        <label class="font-primary text-base text-cht-gray-150 sm:w-44" for="button_text_color_for_<?php echo esc_attr($social['slug']); ?>">Text color</label>
                                        <div>
                                ...
                                <div class="clr-setting">
                                    <div class="chaty-setting-col flex items-center space-x-3">
                                        <label class="font-primary text-base text-cht-gray-150 sm:w-44" for="button_bg_color_for_<?php echo esc_attr($social['slug']); ?>">Background color</label>
                                        <div>
                            ...
                            <div class="chaty-setting-col sm:flex sm:items-center sm:space-x-3">
                                <label class="font-primary text-cht-gray-150 text-base w-44" for="button_text_for_<?php echo esc_attr($social['slug']); ?>">Button text</label>
                                <div>
                                    <input id="button_text_for_<?php echo esc_attr($social['slug']); ?>" type="text" name="cht_social_<?php echo esc_attr($social['slug']); ?>[button_text]" value="<?php echo esc_attr($field_value); ?>" >
                                </div>
                            </div>
                            <?php $field_value = isset($value['thanks_message']) ? $value['thanks_message'] : "Your message was sent successfully" ?>
                            <div class="chaty-setting-col sm:flex sm:items-center sm:space-x-3">
                                <label class="font-primary text-cht-gray-150 text-base w-44" for="thanks_message_for_<?php echo esc_attr($social['slug']); ?>">Thank you message</label>
                                <div>
                                    <input id="thanks_message_for_<?php echo esc_attr($social['slug']); ?>" type="text" name="cht_social_<?php echo esc_attr($social['slug']); ?>[thanks_message]" value="<?php echo esc_attr($field_value); ?>" >
                                </div>
                            </div>
                            ...
                            <div class="chaty-setting-col">
                                ...
                                <label class="chaty-switch flex items-center" for="redirect_action_<?php echo esc_attr($social['slug']); ?>">
                                    ...
                                    <div class="chaty-slider round"></div>
                                    <span class="font-primary text-cht-gray-150 text-base">Redirect visitors after submission</span>
                                </label>
                            </div>
                            <div class="redirect_action-settings <?php echo ($field_value == "yes") ? "active" : "" ?>">
                                ...
                                <div class="chaty-setting-col">
                                    <label class="font-primary text-cht-gray-150" for="redirect_link_for_<?php echo esc_attr($social['slug']); ?>">Redirect link</label>
                                    <div class="mb-2">
                            ...
                            <div class="chaty-setting-col">
                                ...
                                <label class="chaty-switch flex items-center" for="close_form_after_<?php echo esc_attr($social['slug']); ?>">
                                    ...
                                    <div class="chaty-slider round"></div>
                                    <span class="font-primary text-cht-gray-150 text-base">Close form automatically after submission</span>
                                    <span class="icon label-tooltip inline-message" data-title="Close the form automatically after a few seconds based on your choice">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                                            <path d="M8.00004 14.6654C11.6819 14.6654 14.6667 11.6806 14.6667 7.9987C14.6667 4.3168 11.6819 1.33203 8.00004 1.33203C4.31814 1.33203 1.33337 4.3168 1.33337 7.9987C1.33337 11.6806 4.31814 14.6654 8.00004 14.6654Z" stroke="#72777c" stroke-width="1.33" stroke-linecap="round" stroke-linejoin="round"></path>
                                            <path d="M8 10.6667V8" stroke="#72777c" stroke-width="1.33" stroke-linecap="round" stroke-linejoin="round"></path>
                                            <path d="M8 5.33203H8.00667" stroke="#72777c" stroke-width="1.33" stroke-linecap="round" stroke-linejoin="round"></path>
                            ...
                            <div class="close_form_after-settings <?php echo ($field_value == "yes") ? "active" : "" ?>">
                                ...
                                <div class="chaty-setting-col">
                                    <label class="font-primary text-cht-gray-150" for="close_form_after_seconds_<?php echo esc_attr($social['slug']); ?>">Close after (Seconds)</label>
                                    <div>
                            ...
                            <div class="email-settings <?php echo ($field_value == "yes") ? "active" : "" ?>">
                                <div class="chaty-setting-col">
                                    <label class="font-primary text-cht-gray-150" for="email_for_<?php echo esc_attr($social['slug']); ?>">
                                        ...
                                        <span class="icon label-tooltip email-tooltip -mt-[9px]" data-title="If you want to send leads to more than one email address, please add your email addresses separated by commas">
                                            <span>
                                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                                                    <path d="M8.00004 14.6654C11.6819 14.6654 14.6667 11.6806 14.6667 7.9987C14.6667 4.3168 11.6819 1.33203 8.00004 1.33203C4.31814 1.33203 1.33337 4.3168 1.33337 7.9987C1.33337 11.6806 4.31814 14.6654 8.00004 14.6654Z" stroke="#72777c" stroke-width="1.33" stroke-linecap="round" stroke-linejoin="round"></path>
                                                    <path d="M8 10.6667V8" stroke="#72777c" stroke-width="1.33" stroke-linecap="round" stroke-linejoin="round"></path>
                                ...
                                <div class="chaty-setting-col">
                                    <label class="font-primary text-cht-gray-150" for="sender_email_for_<?php echo esc_attr($social['slug']); ?>">Sender's email <span class="icon label-tooltip email-tooltip -mt-[9px]" data-title="This is the email address from which you will receive each contact form submission email. By default, it is sent from the user's email address. To avoid email rejection, change it to an email address that includes your website domain."><span>
                                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                                                <path d="M8.00004 14.6654C11.6819 14.6654 14.6667 11.6806 14.6667 7.9987C14.6667 4.3168 11.6819 1.33203 8.00004 1.33203C4.31814 1.33203 1.33337 4.3168 1.33337 7.9987C1.33337 11.6806 4.31814 14.6654 8.00004 14.6654Z" stroke="#72777c" stroke-width="1.33" stroke-linecap="round" stroke-linejoin="round"></path>
                                                <path d="M8 10.6667V8" stroke="#72777c" stroke-width="1.33" stroke-linecap="round" stroke-linejoin="round"></path>
                                                <path d="M8 5.33203H8.00667" stroke="#72777c" stroke-width="1.33" stroke-linecap="round" stroke-linejoin="round"></path>
                                ...
                                <div class="chaty-setting-col">
                                    <label class="font-primary text-cht-gray-150" for="sender_name_for_<?php echo esc_attr($social['slug']); ?>">Sender's name <span class="icon label-tooltip email-tooltip -mt-[9px]" data-title="The name that will appear as the sender name in your email. Use {name} to dynamically use the name from form submission."><span>
                                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                                                <path d="M8.00004 14.6654C11.6819 14.6654 14.6667 11.6806 14.6667 7.9987C14.6667 4.3168 11.6819 1.33203 8.00004 1.33203C4.31814 1.33203 1.33337 4.3168 1.33337 7.9987C1.33337 11.6806 4.31814 14.6654 8.00004 14.6654Z" stroke="#72777c" stroke-width="1.33" stroke-linecap="round" stroke-linejoin="round"></path>
                                                <path d="M8 10.6667V8" stroke="#72777c" stroke-width="1.33" stroke-linecap="round" stroke-linejoin="round"></path>
                                                <path d="M8 5.33203H8.00667" stroke="#72777c" stroke-width="1.33" stroke-linecap="round" stroke-linejoin="round"></path>
                                ...
                                <div class="chaty-setting-col">
                                    <label class="font-primary text-cht-gray-150" for="email_subject_for_<?php echo esc_attr($social['slug']); ?>">Email subject <span class="icon label-tooltip email-tooltip -mt-[9px]" data-title="The subject line of the emails that you'll receive from each contact form submission. You can use dynamic tags">
                                        <span>
                                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                                                <path d="M8.00004 14.6654C11.6819 14.6654 14.6667 11.6806 14.6667 7.9987C14.6667 4.3168 11.6819 1.33203 8.00004 1.33203C4.31814 1.33203 1.33337 4.3168 1.33337 7.9987C1.33337 11.6806 4.31814 14.6654 8.00004 14.6654Z" stroke="#72777c" stroke-width="1.33" stroke-linecap="round" stroke-linejoin="round"></path>
                                                <path d="M8 10.6667V8" stroke="#72777c" stroke-width="1.33" stroke-linecap="round" stroke-linejoin="round"></path>
                ...
                <?php if ($this->is_pro()) { ?>
                    <div class="Email-settings advanced-settings">
                        ...
                        <div class="chaty-setting-col sm:flex items-start sm:space-x-3">
                            <label class="font-primary text-cht-gray-150 w-44 flex">Mail Subject 
                                <span class="icon label-tooltip inline-tooltip" data-title="Add your own pre-set message that's automatically added to the user's message. You can also use merge tags and add the URL or the title of the current visitor's page. E.g. you can add the current URL of a product to the message so you know which product the visitor is talking about when the visitor messages you">
                                    <span class="ml-2">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                                            <path d="M8.00004 14.6654C11.6819 14.6654 14.6667 11.6806 14.6667 7.9987C14.6667 4.3168 11.6819 1.33203 8.00004 1.33203C4.31814 1.33203 1.33337 4.3168 1.33337 7.9987C1.33337 11.6806 4.31814 14.6654 8.00004 14.6654Z" stroke="#72777c" stroke-width="1.33" stroke-linecap="round" stroke-linejoin="round"></path>
                    ...
                    <div class="WeChat-settings advanced-settings">
                        ...
                        <div class="clear clearfix"></div>
                        <div class="chaty-setting-col flex items-center space-x-3">
                            <label class="font-primary text-base text-cht-gray-150 sm:w-44">Upload QR Code</label>
                            <div class="relative">
                    ...
                    <div class="Link-settings Custom_Link-settings Custom_Link_3-settings Custom_Link_4-settings Custom_Link_5-settings advanced-settings">
                        ...
                        <div class="clear clearfix"></div>
                        <div class="chaty-setting-col flex items-center space-x-3">
                            <label class="font-primary text-cht-gray-150 sm:w-44 text-base" for="cht_social_window_<?php echo esc_attr($social['slug']); ?>">Open In a New Tab</label>
                            <div class="l-height">
                    ...
                    <div class="Linkedin-settings advanced-settings">
                        ...
                        <!-- Advance setting for Custom Link -->
                        <div class="chaty-setting-col sm:flex sm:items-center sm:space-x-3">
                            <label class="font-primary text-cht-gray-150 w-44">LinkedIn</label>
                            <div class="cta-action-radio tab-tab-select bg-cht-gray-50 inline-block rounded-md p-1">
                                <div class="i-block" for="all_time-cht_cta_action">
                                    <label class="custom-control custom-radio">
                                        ...
                                        <span class="custom-control-label px-2 py-1 inline-block text-cht-gray-150 rounded-[3px]">Personal</span>
                                    </label>
                                </div>
                                <div class="i-block" for="all_time-cht_cta_action">
                                    <label class="custom-control custom-radio">
                                        ...
                                        <span class="custom-control-label px-2 py-1 inline-block text-cht-gray-150 rounded-[3px]">Company</span>
                                    </label>
                                </div>
                            </div>
                        </div>
                ...
                <?php } else { ?>
                    ...
                    <div class="Email-settings advanced-settings">
                        ...
                        <div class="chaty-setting-col flex items-start space-x-3">
                            <label class="font-primary text-cht-gray-150 w-44">Mail Subject 
                                <span class="icon label-tooltip inline-tooltip" data-title="Add your own pre-set message that's automatically added to the user's message. You can also use merge tags and add the URL or the title of the current visitor's page. E.g. you can add the current URL of a product to the message so you know which product the visitor is talking about when the visitor messages you">
                    ...
                    <div class="WeChat-settings advanced-settings">
                        <div class="clear clearfix"></div>
                        <div class="chaty-setting-col flex items-center space-x-3">
                            <label class="font-primary text-cht-gray-150 text-base w-44">Upload QR Code</label>
                            <div>
                    ...
                    <div class="Link-settings Custom_Link-settings Custom_Link_3-settings Custom_Link_4-settings Custom_Link_5-settings advanced-settings">
                        ...
                        <div class="clear clearfix"></div>
                        <div class="chaty-setting-col flex items-center space-x-3">
                            <label class="font-primary text-cht-gray-150 text-base sm:w-44" for="cht_social_window_<?php echo esc_attr($social['slug']); ?>">Open In a New Tab</label>
                            <div class="l-height">
                                <input type="hidden" name="cht_social_<?php echo esc_attr($social['slug']); ?>[new_window]" value="0" >
                                <label class="channels__view" for="cht_social_window_<?php echo esc_attr($social['slug']); ?>">
                        ...
                        <div class="chaty-setting-col sm:flex sm:items-center sm:space-x-3">
                            ...
                            <div class="cta-action-radio tab-tab-select bg-cht-gray-50 inline-block rounded-md p-1">
                                ...
                                <div class=" disable-message" data-title='When the default state is set to "Opened by default", the "Show call to action" feature doesn&apos;t apply because the Chaty widget is already open.' for="all_time-cht_cta_action">
                                    <label class="custom-control custom-radio">
                                        <input type="radio" name="cht_social_<?php echo esc_attr($social['slug']); ?>[link_type]" class="custom-control-input" <?php checked($is_checked, "company") ?> value="company" />
                                        <span class="custom-control-label px-2 py-1 inline-block text-cht-gray-150 rounded-[3px]">Compnay</span>
                                    </label>
                                </div>
                            </div>
                        </div>
                                            ...
                                            <div class="agent-channel-setting" id="agent-<?php echo esc_attr($slug) ?>-<?php echo esc_attr($count) ?>" data-item="<?php echo esc_attr($count) ?>">
                                                <div class="agent-channel-setting-top px-2 sm:pl-3 sm:pr-5">
                                                    <div class="flex items-center">
                                                        ...
                                                        <div class="agent-icon <?php echo esc_attr($imgClass) ?>" id="image_agent_data_<?php echo esc_attr($social['slug']) ?>-<?php echo esc_attr($count) ?>">
                                                            ...
                                                            <span class="agent-info-image header-tooltip">
                                                                <span class="header-tooltip-text text-center">This channel is an instance of the main channel</span>
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                                                                    <path d="M8.00004 14.6654C11.6819 14.6654 14.6667 11.6806 14.6667 7.9987C14.6667 4.3168 11.6819 1.33203 8.00004 1.33203C4.31814 1.33203 1.33337 4.3168 1.33337 7.9987C1.33337 11.6806 4.31814 14.6654 8.00004 14.6654Z" stroke="#72777c" stroke-width="1.33" stroke-linecap="round" stroke-linejoin="round"></path>
                                                                    <path d="M8 10.6667V8" stroke="#72777c" stroke-width="1.33" stroke-linecap="round" stroke-linejoin="round"></path>
                                                                    <path d="M8 5.33203H8.00667" stroke="#72777c" stroke-width="1.33" stroke-linecap="round" stroke-linejoin="round"></path>
                                                ...
                                                <div class="agent-channel-setting-advance hidden">
                                                    <div class="grid grid-cols-2 gap-5">
                                                        ...
                                                        <div>
                                                            <label class="font-priamry text-cht-gray-150/70 text-base mb-2 block">Custom Image</label>
                                                        ...
                                                        <!-- input for custom color -->
                                                        <div>
                                                            <label class="font-priamry text-cht-gray-150/70 text-base mb-2 block">Icon Appearance</label>
                                                        ...
                                                        <div>
                                                            <label class="font-priamry text-cht-gray-150/70 text-base mb-2 block">Change Icon</label>
                                                        ...
                                                        <?php if ($social['slug'] == "Linkedin") { ?>
                                                            ...
                                                            <!-- Advance setting for Custom Link -->
                                                            <div>
                                                                <label class="font-priamry text-cht-gray-150/70 text-base block" >LinkedIn</label>
                    ...
                    <div class="agent-channel-setting"  id="agent-<?php echo esc_attr($slug) ?>-__count__" data-item="__count__">
                        ...
                        <div class="agent-channel-setting-advance hidden">
                            <div class="grid grid-cols-2 gap-5">
                                ...
                                <?php if ($social['slug'] == "Linkedin") { ?>
                                <div>
                                    <label class="font-priamry text-cht-gray-150/70 text-base mb-2 block" >LinkedIn</label>
