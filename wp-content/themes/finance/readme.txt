...
Pictor, Copyright 2016
Burger is licensed under GNU General Public License V2 or later. You can find a copy of it in the license.txt file.
...
2. Icons
The icon set used in Burger is FontAwesome.
Copyright: Dave Gandy
Resource URI: http://fontawesome.io
License: SIL Open Font License, Version 1.1
License URI: https://scripts.sil.org/OFL?

The icon set used in Burger is Linecons.
...
Theme documentation is available on http://themesflat.com/documentation/finance/