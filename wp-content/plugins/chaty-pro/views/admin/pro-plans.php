...
$features = [
    [
        'title' => esc_html__("Unlimited channels", "chaty"),
        'tooltip' => esc_html__("Show up to 25 channels of your choice","chaty")
    ],
    [
    ...
    [
        'title' => esc_html__("Dynamic chat pop-up", "chaty"),
    ...
    [
        ...
        'tooltip' => esc_html__("Locate the widget exactly where you want by the pixel - X,Y", "chaty")
    ],
    [
    ...
    [
        'title' => esc_html__("Available days and hours", "chaty"),
    ...
    [
        'title' => esc_html__("Send leads to email", "chaty"),
    ...
    [
        'title' => esc_html__("Date scheduling ", "chaty"),
    ...
    [
        'title' => esc_html__("Other various features", "chaty"),
                    ...
                    <div class="pricing-header-top">
                        <div class="plan-row">
                            <div class="plan-col first-col plan-data">
                                <span class="plan-plugin-name">Chaty</span>
                            ...
                            <div class="plan-col plan-detail plan-info" data-plan="1_website">
                                ...
                                <span class="plan-button">
                                    ...
                                    <?php } else if($planPriceId > $plans['1_website']['1_year']['price_id']) { ?>
                                        <a class="purchase-link hide-plan-button" href="<?php echo esc_url($plans['1_website']['1_year']['link']) ?>" >N/A</a>
                                    <?php } else { ?>
                                        <a class="purchase-link" href="<?php echo esc_url($plans['1_website']['1_year']['link']) ?>" target="_blank">Upgrade Plan</a>
                                    <?php } ?>
                                </span>
                            </div>
                            <div class="plan-col plan-detail plus-plans plan-info" data-plan="5_websites">
                                ...
                                <span class="plan-button">
                                    ...
                                    <?php } else if($planPriceId > $plans[$agency_plan]['1_year']['price_id']) { ?>
                                        <a class="purchase-link hide-plan-button" href="javascript:;" >N/A</a>
                                    <?php } else { ?>
                                        <a class="purchase-link" href="<?php echo esc_url($plans[$agency_plan]['1_year']['link']) ?>" target="_blank">Upgrade Plan</a>
                                    <?php } ?>
                                </span>
                            </div>
                            <div class="plan-col agency-plans plan-detail plan-info multiple-plan-info" data-plan="<?php echo esc_attr($agency_plan) ?>">
                                ...
                                <span class="plan-price"><span>$<?php echo esc_attr($plans[$agency_plan]['1_year']['price']) ?></span>/year</span>
                                <span class="plan-type">Billed Annually</span>
                                <span class="plan-monthly">Less than $<?php echo esc_attr($plans[$agency_plan]['1_year']['month']) ?>/mo</span>
                                <span class="update-support">Updates & Support for</span>
                                <div class="plan-selector">
                                    <select class="multiple-options">
                ...
                <div class="mobile-plans">
                    <div class="mobile-plan" data-plan="">
                        ...
                        <div class="plan-head mobile-head-plan plan-info" data-plan="1_website">
                            ...
                            <span class="plan-button"><a class="purchase-link" href="<?php echo esc_url($plans['1_website']['1_year']['link']) ?>" target="_blank">Upgrade Plan</a></span>
                        </div>
                        <div class="plan-body">
                            <ul>
                                <li>
                    ...
                    <div class="mobile-plan" data-plan="">
                        ...
                        <div class="plan-head mobile-head-plan plus-plans plan-info" data-plan="5_websites">
                            ...
                            <span class="plan-button"><a class="purchase-link" href="<?php echo esc_url($plans['5_websites']['1_year']['link']) ?>" target="_blank">Upgrade Plan</a></span>
                        </div>
                        <div class="plan-body">
                            <ul>
                                <li>
                    ...
                    <div class="mobile-plan" data-plan="">
                        ...
                        <div class="plan-head mobile-head-plan plan-info multiple-plan-info" data-plan="50_websites">
                            ...
                            <span class="plan-button"><a class="purchase-link" href="<?php echo esc_url($plans['50_websites']['1_year']['link']) ?>" target="_blank">Upgrade Plan</a></span>
                        </div>
                        <div class="plan-body">
                            <ul>
                                <li>
...
<div class="premio-faqs">
    <div class="price-container">
        ...
        <div class="faq-lists">
            ...
            $faqs = [
                [
                    'question' => "How long is my paid Chaty plugin license valid for?",
                    'answer' => "Once you purchase any paid plan of Chaty, you can use it forever. Support and updates are available for 1 year. You can renew your license yearly to get another year of support and updates."
                ],
                [
                    'question' => "Can I use Chaty plugin on more than 1 domain?",
                    'answer' => "There 2 ways to do it:
                        <ul>
                        <li>You can install the free Chaty plugin on any website you want</li>
                ...
                [
                    'question' => "Will Chaty stop working if I don’t renew my license?",
                    'answer' => "Of course NOT!<br/>Chaty plugin and all your settings will continue to work as before; however, you will no longer receive plugin updates, including feature additions, improvements, and support."
                ],
            ];
...
<div class="hide-plan-page">
    ...
    <a href="#" id="hide-plan-page">Hide "Manage Your Plan" page</a>
</div>
